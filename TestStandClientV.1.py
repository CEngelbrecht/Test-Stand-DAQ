...
class Client(QMainWindow):
	...
	def Buttons(self):
		...
		self.VObtn = createButton(self,'Vents Close',5,130,285,90,True,self.font5,self.vents_open_app,'icon.png',100,100)
		...
		self.so8btn = createButton(self,'Purge Open',360,130,270,70,True,self.font2,self.so8_app,'icon.png',100,100)
		self.so9btn = createButton(self,'Solenoid 9 Open',360,205,270,70,True,self.font2,self.so9_app,'icon.png',100,100)
		self.sc8btn = createButton(self,'Purge Close',660,130,270,70,False,self.font2,self.sc8_app,'icon.png',100,100)
		self.sc9btn = createButton(self,'Solenoid 9 Close',660,205,270,70,False,self.font2,self.sc9_app,'icon.png',100,100)
		self.sc1btn = createButton(self,'LOX HI Open',300,440,270,70,False,self.font2,self.sc1_app,'icon.png',100,100)
		self.sc2btn = createButton(self,'CH4 Vent Open',300,515,270,70,False,self.font2,self.sc2_app,'icon.png',100,100)
		self.sc3btn = createButton(self,'CH4 HI Open',300,590,270,70,False,self.font2,self.sc3_app,'icon.png',100,100)
		self.sc4btn = createButton(self,'LOX Vent Open',300,665,270,70,False,self.font2,self.sc4_app,'icon.png',100,100)
		self.sc5btn = createButton(self,'CH4 MPV Open',300,740,270,70,False,self.font2,self.sc5_app,'icon.png',100,100)
		self.sc6btn = createButton(self,'LOX MPV Open',300,815,270,70,False,self.font2,self.sc6_app,'icon.png',100,100)
		self.sc7btn = createButton(self,'Solenoid 7 Close',300,890,270,70,False,self.font2,self.sc7_app,'icon.png',100,100)	
		self.so1btn = createButton(self,'LOX HI Close',20,440,270,70,True,self.font2,self.so1_app,'icon.png',100,100)
		self.so2btn = createButton(self,'CH4 Vent Close',20,515,270,70,True,self.font2,self.so2_app,'icon.png',100,100)
		self.so3btn = createButton(self,'CH4 HI Close',20,590,270,70,True,self.font2,self.so3_app,'icon.png',100,100)
		self.so4btn = createButton(self,'LOX Vent Close',20,665,270,70,True,self.font2,self.so4_app,'icon.png',100,100)
		self.so5btn = createButton(self,'CH4 MPV Close',20,740,270,70,True,self.font2,self.so5_app,'icon.png',100,100)
		self.so6btn = createButton(self,'LOX MPV Close',20,815,270,70,True,self.font2,self.so6_app,'icon.png',100,100)
		self.so7btn = createButton(self,'Solenoid 7 Open',20,890,270,70,True,self.font2,self.so7_app,'icon.png',100,100)

		self.VCbtn = createButton(self,'Vents Open',660,440,285,90,True,self.font5,self.vents_close_app,'icon.png',100,100) 
		#The labels on the vents buttons are backwards, but the apps and MQTT commands are right 
		self.MPVOpen = createButton(self,'MPV Open',660,515,270,70,True,self.font2,self.mpv_open_app,'icon.png',100,100)
		self.MPVClose = createButton(self,'MPC Close',660,590,270,70,True,self.font2,self.mpv_close_app,'icon.png',100,100)
	...
	def send_info(self,command):
		...
		elif command == 'Mains_O':
			message = b'Mains_O'
			logger.debug("Vents Close at {}".format(time.asctime()))
		elif command == 'Mains_C':
			message = b'Mains_C'
			logger.debug("Vents Close at {}".format(time.asctime()))
